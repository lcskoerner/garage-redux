...
CarNew = connect(mapStateToProps, { addCar }, null, { forwardRef: false })(CarNew);

export default reduxForm({
  form: 'newCarForm' // a unique name for this form
})(CarNew);

// export default reduxForm({
//   form: 'newCarForm' // a unique identifier
// })(connect(mapStateToProps, { addCar }, null, { forwardRef: true })(CarNew));
